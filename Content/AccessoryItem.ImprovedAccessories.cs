...
public partial class AccessoryItem
{
    /* TODO: add back
        ...
        private static void ReplaceBOBTexture()
        {
            ...
            if (ServerConfig.Instance.ImprovedHorseshoeBundle)
            {
        ...
        private static void ModifyAccessoryStats(Item item)
        {
            switch (item.type)
            {
                case ItemID.AnkhShield:
                    if (ServerConfig.Instance.ImprovedAnkhShield)
                    {
        ...
        private static void ModifyAccessoryEffects(Item item, Player player, bool hideVisual)
        {
            switch (item.type)
            {
                case ItemID.HandOfCreation:
                    // Hand of creation
                    if (ServerConfig.Instance.ImprovedHandOfCreation)
                    {
                ...
                case ItemID.TerrasparkBoots:
                    // Terraspark boots
                    if (ServerConfig.Instance.ImprovedTerrasparkBoots)
                    {
        ...
        private static void ModifyAccessoryTooltips(Item item, List<TooltipLine> tooltips)
        {
            switch (item.type)
            {
                case ItemID.HandOfCreation:
                    ...
                    if (ServerConfig.Instance.ImprovedHandOfCreation)
                    {
                        tooltips.InsertTooltips("Tooltip2", after: true, TooltipUtils.GetTooltipLine("HandOfCreation0"), TooltipUtils.GetTooltipLine("HandOfCreation1"));
                ...
                case ItemID.TerrasparkBoots:
                    // Terraspark boots
                    if (ServerConfig.Instance.ImprovedTerrasparkBoots)
                        tooltips.InsertTooltips("Tooltip4", after: true, TooltipUtils.GetTooltipLine("TerrasparkBoots0"), TooltipUtils.GetTooltipLine("TerrasparkBoots1"));

                    break;
                case ItemID.AnkhShield:
                    // Ankh shield
                    if (ServerConfig.Instance.ImprovedAnkhShield)
                        tooltips.InsertTooltips("Tooltip1", after: true, TooltipUtils.GetTooltipLine("AnkhShield0"), TooltipUtils.GetTooltipLine("AnkhShield1"), TooltipUtils.GetTooltipLine("AnkhShield2"));
                ...
                case ItemID.HorseshoeBundle:
                    ...
                    if (ServerConfig.Instance.ImprovedHorseshoeBundle)
                    {
                        tooltips.InsertTooltips("Tooltip0", after: true, TooltipUtils.GetTooltipLine("BundleOfBalloons0"));
                ...
                case ItemID.Radar:
                    ...
                    {
                        tooltips.InsertTooltips("Tooltip0", after: true, TooltipUtils.GetTooltipLine("Radar0"));
                        tooltips.RemoveTooltips("Tooltip0");
                    }
